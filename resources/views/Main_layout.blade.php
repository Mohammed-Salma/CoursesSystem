...
<head>
    ...
    <title>@yield('title', 'أكاديمية الكورسات')</title>
    <!-- Font Awesome Icons -->
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="{{ asset('admin/#') }}" class="dropdown-item dropdown-footer">See All
                            Notifications</a>
                    </div>
                </li>
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="{{ asset('admin/#') }}" class="d-block">Mohamed Salma</a>
                    </div>
                </div>
