            ...
            <div class="card-header">
                <h3 class="card-title" style="text-align: center; float: none;">بيانات الكورسات
                    <a href="{{ route('courses.create') }}" class="button"
                        style="background-color: #04AA6D; color: white; padding: 10px; float: left;">إضافة كورس جديد</a>
                </h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('courses.edit', $info->id) }}" class="button"
                                            style="background-color: #04AA6D; color: white; padding: 10px">تعديل</a>
                                        <a href="{{ route('courses.destroy', $info->id) }}" class="button"
                                            style="background-color: #aa0704; color: white; padding: 10px">حذف</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
